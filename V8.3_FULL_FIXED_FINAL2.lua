...
print("[V8.2] UI/root:", UI)
    ...
    C.UI.SetOpen = function(self, state)
        ...
        if typeof(u1238) == 'Instance' and typeof(u1238.TabFrame) == 'Instance' then
            u1238.TabFrame.Visible = openState
        end
