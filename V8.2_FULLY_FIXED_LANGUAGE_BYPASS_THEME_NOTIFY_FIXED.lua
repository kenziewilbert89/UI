...
C.u40.__GetRootPart = function(character)
    ...
    -- The constructor can return the real UI object immediately.
        ...
        -- V8.2 PUBLIC API FIX: expose notification and a simple theme alias
        -- on the returned UI object. The internal implementation lives on
        -- C.u40, while v926 is the object exported to library users.
        v926.Notify = function(_, message)
            if message == nil then
                return
            end
            return C.u40:Notify(tostring(message))
        end

        v926.SetTheme = function(self, themeName)
