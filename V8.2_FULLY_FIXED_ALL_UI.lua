    ...
    -- The constructor can return the real UI object immediately.
        ...
        function v926.AddTab(_, p1288, p1289)
            ...
            function u1240.Coroutine()
                ...
                -- Wait only for the game-loaded state. The old decompiled
                -- code contained an unconditional `while true` around the
                -- entire tab-property builder, so AddTab never returned.
